...
export class MessagesDAO {
    ...
    constructor() {
        this.messages.push(new Message("United Federation of Nations High Command", { orig: "How to pilot the starship" }, { orig: "Use the `setThrust`, `setDesiredAngle`, `halt` and `moveTo` GraphQL Mutations to pilot the ship!" }));
